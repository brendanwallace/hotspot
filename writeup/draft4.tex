...
\urlstyle{same}
\hypersetup{
  pdftitle={Hot-spot model of risk structured disease spread},
  hidelinks,
...
\section{0.5. Significance Statement}\label{significance-statement}
...
disproportionately large number of total infections {[}@nature2005{]}.
